...
public class ResumeView {
    ...
    public PersonInfo inputPersonInfo() {
        System.out.print("사진 파일명을 입력해 주세요 : ");
        ...
        System.out.print("생년월일을 입력 해 주세요 : ");
    ...
    public List<Education> inputEducationList() {
        ...
        while (true) {
            System.out.println("학력 정보를 입력해 주세요 :  ( 종료 : q )");
    ...
    public List<Career> inputCareerList() {
        ...
        while (true) {
            System.out.println("경력정보를 입력해 주세요 :  ( 종료 : q )");
    ...
    public String inputSelfIntroduction(){
        System.out.println("자기소개서를 입력 하세요 :  여러줄을 입력 하려면 빈 줄을 입력 하세요. ");
